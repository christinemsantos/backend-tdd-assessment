...
def create_parser():
    ...
    parser.add_argument("-u", "--upper", action="store_true", help="converts text to uppercase")
    parser.add_argument("-l", "--lower", action="store_true", help="converts text to lowercase")
    parser.add_argument("-t", "--title", action="store_true", help="converts text to titlecase")
